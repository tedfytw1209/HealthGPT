...
HLORA_PATH="/orange/chenaokun1990/tienyu/HealthGPT_pretrain/gen_hlora_weights.bin"
FUSION_LAYER_PATH="/orange/chenaokun1990/tienyu/HealthGPT_pretrain/fusion_layer_weights.bin"
